...
contract VulnerableContract {
    ...
    function callContractAgain(address yourAddress, bytes4 selector) public returns (bool) {
        ...
        (bool success, bytes memory returnData) = yourAddress.call(abi.encodeWithSelector(selector));
        require(success);
        if (s_otherVar == 2) {
            return true;
        }
...
contract CourseCompletedNFT is ERC721 {
    string public constant TOKEN_IMAGE_URI = "ipfs://QmeHo8yoogtNC1aajU6Bn8HEWTGjfv8m7m8ZdDDUzNBXij";
